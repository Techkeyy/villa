...
| 2:05-2:30 | Point to the labeled MINT TX, ORDER TX, CANCEL TX, and BURN TX. "The order was cancelled, paired inventory was burned, and capital reconciled to `1,002,000` raw tUSDC. YES, NO, and open orders ended at zero. Owner withdrawal was not called, and execution remains disabled."
