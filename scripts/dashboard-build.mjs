...
for (const name of ["index.html", "styles.css", "app.mjs", "control-client.mjs", "account-client.mjs", "account-config.mjs", "account-journey.mjs", "account-readiness.mjs", "liquidity-flow.mjs", "authorization-flow.mjs", "villa-account-artifact.json", "favicon.svg"]) await fs.copyFile(path.join(source, name), path.join(output, name));
