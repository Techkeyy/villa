...
for (const name of ["styles.css", "app.mjs", "control-client.mjs", "account-client.mjs", "account-config.mjs", "account-journey.mjs", "account-readiness.mjs", "liquidity-flow.mjs", "authorization-flow.mjs", "uat-monitor.mjs", "villa-account-artifact.json", "villa-account-artifact-v1.json", "favicon.svg"]) await fs.copyFile(path.join(source, name), path.join(output, name));
...
for (const name of ["app.mjs", "control-client.mjs", "account-client.mjs", "account-config.mjs", "account-journey.mjs", "account-readiness.mjs", "liquidity-flow.mjs", "authorization-flow.mjs", "uat-monitor.mjs", "villa-account-artifact.json", "villa-account-artifact-v1.json"]) await fs.access(path.join(output, name));
